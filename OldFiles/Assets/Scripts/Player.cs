...
public class Player : MovingObject {
	...
	private void OnTriggerEnter2D (Collider2D other)
	{
		...
		if (other.tag == "Exit")
		{
			...
			GameManager.MusicPlayer.RandomizeSfx(eatSound1, eatSound2);
		} else if (other.tag == "Soda") {
			food += pointsPerSoda;
			foodText.text = "+"  + pointsPerSoda + " Food: " + food;
			other.gameObject.SetActive(false);
			GameManager.MusicPlayer.RandomizeSfx(drinkSound1, drinkSound2);
		}
	}
	...
	private void Restart()
	{
	    ...
	    GameManager.instance.OnLevelWasLoaded(1);
	}
